...
public final class HatItemRegistry {
    ...
    private static final List<Item> ALL_HATS_REGISTRY = new ArrayList<>();
    ...
    public static List<Item> getAllHats() {
        if (ALL_HATS_LIST.isEmpty() && !ALL_HATS_REGISTRY.isEmpty()) {
            ALL_HATS_LIST.addAll(ALL_HATS_REGISTRY);
        }
        ...
        try {
            ...
            Files.list(modelsPath)
                    ...
                    .forEach(path -> {
                        ...
                        Item item = new HatItem(name);
                        Registry.register(
                                BuiltInRegistries.ITEM,
                                ResourceLocation.fromNamespaceAndPath(Hats.MODID, name),
                                item
                        );
                        ALL_HATS_REGISTRY.add(item);
                    });
